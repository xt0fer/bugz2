package rocks.zipcode.bugz2.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, rocks.zipcode.bugz2.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, rocks.zipcode.bugz2.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, rocks.zipcode.bugz2.domain.Note.class.getName());
            createCache(cm, rocks.zipcode.bugz2.domain.Note.class.getName() + ".tickets");
