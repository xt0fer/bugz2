...
import rocks.zipcode.bugz2.repository.NoteRepository;
import rocks.zipcode.bugz2.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link rocks.zipcode.bugz2.domain.Note}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Note> result = noteRepository
            ...
            .map(existingNote -> {
                ...
                if (note.getCreated() != null) {
                    existingNote.setCreated(note.getCreated());
                }
                if (note.getDesc() != null) {
                    existingNote.setDesc(note.getDesc());
                }
