...
/**
 * REST controller for managing {@link rocks.zipcode.bugz2.domain.Ticket}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TicketResource {
    ...
    public List<Ticket> getAllAssignedTickets() {
        log.info("REST request to get all findByAssignedToIsCurrentUser");
    ...
    public List<Ticket> getAllReportedTickets() {
        log.info("REST request to get all findByReportedByIsCurrentUser");
