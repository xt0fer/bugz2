...
import rocks.zipcode.bugz2.domain.Project;
import rocks.zipcode.bugz2.repository.ProjectRepository;
import rocks.zipcode.bugz2.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link rocks.zipcode.bugz2.domain.Project}.
 */
@RestController
@RequestMapping("/api")
@Transactional
