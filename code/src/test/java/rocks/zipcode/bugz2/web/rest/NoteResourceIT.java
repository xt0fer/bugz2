...
class NoteResourceIT {
    ...
    public static Note createEntity(EntityManager em) {
        Note note = new Note().content(DEFAULT_CONTENT).created(DEFAULT_CREATED).desc(DEFAULT_DESC);
        return note;
    }
    ...
    public static Note createUpdatedEntity(EntityManager em) {
        Note note = new Note().content(UPDATED_CONTENT).created(UPDATED_CREATED).desc(UPDATED_DESC);
        return note;
    }
    ...
    void createNote() throws Exception {
        ...
        assertThat(testNote.getDesc()).isEqualTo(DEFAULT_DESC);
    }
    ...
    void putExistingNote() throws Exception {
        ...
        updatedNote.content(UPDATED_CONTENT).created(UPDATED_CREATED).desc(UPDATED_DESC);
        ...
        assertThat(testNote.getDesc()).isEqualTo(UPDATED_DESC);
    }
    ...
    void fullUpdateNoteWithPatch() throws Exception {
        ...
        partialUpdatedNote.content(UPDATED_CONTENT).created(UPDATED_CREATED).desc(UPDATED_DESC);
